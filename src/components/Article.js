...
class Article extends Component {
  ...
  renderEditButtons() {
    ...
    if (this.state.mode === EDIT_MODE) {
      return (
        <div>
          <div className="edit button" onClick={this.saveArticle.bind(this)}>
            Save
          </div>
          <div className="edit button" onClick={this.cancelEdit.bind(this)}>
            Cancel
          </div>
        </div>
      );
      ...
      return (
        <div>
          <div
            ...
            onClick={this.setMode.bind(this, EDIT_MODE)}>
            Edit
          </div>
          <div
  ...
  renderArticle() {
    ...
    if (this.state.mode === EDIT_MODE) {
      ...
      return (
        <div>
          <a href={article.url} className="url" target="_blank">
            {article.title}
          </a>
          <div className="information">
            <span>
              submitted by{" "}
              <Link to={"/users/" + article.username} className="username">
                {article.username}
              </Link>
            </span>
            {this.renderComments()}
  ...
  renderComments() {
    if (this.props.isArticleView) {
      ...
      return (
        <Link to={"/articles/" + this.props.article.id} className="comments">
          View Comments
        </Link>
      );
    }
